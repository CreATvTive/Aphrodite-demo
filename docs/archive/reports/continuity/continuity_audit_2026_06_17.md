...
> Link note: relative links inside this preserved report reflect its original repository-root context and are historical path evidence, not current navigation. Use [`../../../README.md`](../../../README.md) for the current documentation entry.
> 审计日期：2026-06-17
