...
| Live2D / 语音 / 游戏表现层 | 以架构文档和局部适配器为主，尚非可交付前端 | `architecture/`、`docs/live2d-integration-*.md`、`src/voice/` |
...
├── docs/                  # 设计、契约、报告和演示手册
├── architecture/          # Live2D/协议/接口设计稿
├── research/              # 技术调研
└── emotion-protocol/      # 独立情感控制协议演示
```
...
| [Aphrodite_v2_visual_direction_production_guide.md](Aphrodite_v2_visual_direction_production_guide.md) | 视觉方向与制作约束 |

### 表现层与历史方案

| 文档 | 用途 |
| --- | --- |
| [docs/live2d-integration-design.md](docs/live2d-integration-design.md) | Live2D 集成方案设计 |
| [architecture/README.md](architecture/README.md) | Live2D 对话演示架构索引 |
| [docs/demo_architecture_v2.md](docs/demo_architecture_v2.md) | 本地游戏内嵌方案规划 |
| [docs/memory_system_integration.md](docs/memory_system_integration.md) | 记忆迁移与融合方案记录 |
